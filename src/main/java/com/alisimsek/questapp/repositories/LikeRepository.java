...
public interface LikeRepository extends JpaRepository<Like, Long> {
    ...
    @Query(value = "select 'liked', l.post_id, u.avatar, u.user_name from p_like " +
            "l left join user u on u.id = l.user_id where l.post_id in :postIds limit 5", nativeQuery = true)
